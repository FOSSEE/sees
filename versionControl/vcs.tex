...
\begin{frame}
  ...
  \begin{itemize}
  \item User information can be set using the \typ{config} command.
  \item It can be set globally or local to the project
  \item \typ{git config --global user.name "A U Thor"}
  \item \typ{git config --global user.email "author@example.com"}
\end{frame}
